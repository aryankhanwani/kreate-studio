...
export default function ServicesSection() {
  const services = [
    ...
    },
    {
      ...
      description: 'Bring your stories to life with world-class production. From high-end video to motion graphics, we deliver polished visual content that captivates.',
      services: [
        'Video Production',
        'Content Creation',
        'Photography',
